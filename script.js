// ==========================================================================
// CONFIGURAÇÃO INICIAL (SEPARAÇÃO DE CONCEITOS - EXIGÊNCIA AGRINHO)
// ==========================================================================
document.addEventListener("DOMContentLoaded", () => {
    ...
    // 2. Eventos do Simulador (Previne submit da página e escuta mudanças)
    ...
    // 3. Eventos dos Cards de Agroecologia
    document.querySelectorAll('.agro-card-extended').forEach(card => {
        card.addEventListener('click', () => {
            mostrarModal(card.getAttribute('data-modal'));
        });
    });
...
function executarDiagnostico() {
    ...
    if (nota >= 80) {
        ...
        detalheBox.className = "output-alert bom mt-15";
        ...
        detalheBox.className = "output-alert alerta mt-15";
        ...
        detalheBox.className = "output-alert perigo mt-15";
...
// ==========================================================================
// 2. INFOGRÁFICOS DO POPUP
// ==========================================================================
const dadosEmbrapaPopups = {
    rotacao: { titulo: "🔄 Rotação de Culturas e Cobertura", intro: "Prática baseada no plantio alternado...", beneficios: ["Interrompe o ciclo biológico reprodutivo de pragas e nematoides.", "Melhora significativamente a macroestrutura física do solo através de diferentes sistemas radiculares.", "Aumenta a infiltração de água e reduz drasticamente a erosão laminar."], exemplo: "1º Ano: Milho (explora o solo e gera palhada) → 2º Ano: Soja (fixa nitrogênio) → 3º Ano: Plantas de Cobertura." },
    adubacao: { titulo: "🌱 Adubação Verde e Cobertura Viva", intro: "Utilização estratégica de plantas cultivadas...", beneficios: ["Fixação biológica de Nitrogênio puro a custo zero.", "Proteção mecânica contra o impacto direto das gotas de chuva.", "Aumento expressivo no teor de matéria orgânica e carbono."], exemplo: "Semeadura direta de Crotalária ou Feijão-de-porco nas janelas de entressafras." },
    mip: { titulo: "🐞 MIP - Manejo Integrado de Pragas", intro: "Conjunto ecológico de tomada de decisões...", beneficios: ["Redução drástica no custo de aquisição de defensivos químicos sintéticos.", "Preservação de predadores benéficos.", "Reduz riscos de intoxicação na comunidade."], exemplo: "Uso de armadilhas biológicas de feromônios e liberação assistida de microvespas parasitoides." },
    safs: { titulo: "🌳 Sistemas Agroflorestais (SAFs)", intro: "Abordagem produtiva pioneira que mimetiza a arquitetura...", beneficios: ["Ciclagem profunda de nutrientes capturados por raíces arbóreas.", "Múltiplas fontes de renda na mesma área.", "Criação de microclimas amenos que protegem as plantas contra secas severas."], exemplo: "Consórcio de linhas de eucalipto ou árvores nativas com faixas produtivas de café, milho ou pastagens." },
    nascentes: { titulo: "💧 Recuperação e Proteção de Nascentes", intro: "Intervenção mecânica imediata nas Áreas de Preservação...", beneficios: ["Garantia de vazão contínua e pureza física da água consumida.", "Retorno natural da vegetação ciliar nativa no entorno imediato.", "Evita o assoreamento de córregos e riachos da microbacia."], exemplo: "Instalação de cercas rígidas num raio mínimo de 50 metros e plantio manual de mudas nativas da região." },
    curvas: { titulo: "🚜 Curvas de Nível e Terraceamento", intro: "Técnicas milenares de engenharia rústica...", beneficios: ["Retém a água na lavoura, forçando sua infiltração lenta no lençol freático.", "Impeça o arraste da camada fértil superficial do solo.", "Elimina de forma absoluta a formação de voçorocas e sulcos erosivos."], exemplo: "Marcação de terrenos inclinados com pé-de-galinha ou nível de mangueira para construção de terraços de retenção." }
};
...
// ==========================================================================
// 5. JOGO DA MEMÓRIA (FISHER-YATES MANTIDO E INTACTO)
// ==========================================================================
